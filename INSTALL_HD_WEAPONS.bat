...
rem Python and adb are available. Then double-click this and drag the pack
rem archive in when asked.
setlocal
cd /d "%~dp0"
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0tools\install-hd-weapons.ps1" %*
echo(
pause
